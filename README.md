...
| Agent docs | Every generated app ships a `CLAUDE.md` + `.claude/` and `AGENTS.md` + `doc/` (guidance modules, starter agents, a SessionStart hook) — see [Agent docs](docs/claude-docs.md) |
...
| [Agent docs](docs/claude-docs.md) | Generating and tailoring an app's `CLAUDE.md` + `.claude/` and `AGENTS.md` + `doc/` |
