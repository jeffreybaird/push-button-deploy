...
no_greps  "no MyApp placeholder left in CLAUDE"  "$d/AGENTS.md" 'MyApp'
no_greps  "no my_app placeholder left in CLAUDE" "$d/AGENTS.md" 'my_app'
greps     "module rewritten (CoolThing)"         "$d/AGENTS.md" 'CoolThing'
greps     "app name rewritten in cloud-setup"    "$d/doc/hooks/cloud-setup.sh" 'cool_thing-cloud-setup'
greps     "agent placeholder rewritten"          "$d/doc/agents/code-reviewer.md" 'CoolThing'
no_greps  "agent has no leftover MyApp"          "$d/doc/agents/test-writer.md" 'MyApp'
...
no_greps  "no MyApp placeholder left"            "$d/AGENTS.md" 'MyApp'
no_greps  "no my_app placeholder left"           "$d/AGENTS.md" 'my_app'
greps     "module rewritten (ShopApi)"           "$d/AGENTS.md" 'ShopApi'
...
greps     "title rewritten (Travel Notes)"       "$d/AGENTS.md" 'Travel Notes'
